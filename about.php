        ...
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    ...
                    <h4 class="text-body fst-italic mb-4">Our CCTV systems feature the latest technology, including high-definition video, night vision, motion detection, and remote monitoring capabilities.</h4>
                    <p class="mb-4">Our team of experienced technicians ensures a seamless installation process. We handle everything, from system setup to troubleshooting, leaving you with a hassle-free experience.We don’t stop at installation. Our services include regular maintenance, upgrades, and 24/7 support to keep your security system running optimally.</p>
                    <div class="row g-3">
            ...
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="position-relative rounded-top">
                        <img class="img-fluid rounded-top w-100" src="img/owner.jpg" alt="">
                    ...
                    <div class="bg-primary text-center rounded-bottom p-4">
                        <h3 class="text-white">Prabin</h3>
                        <p class="text-white m-0">CEO & CFO</p>
                    </div>
                </div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <img src="img/udyam.png" class="card-img-top" alt="...">
    </div>
</div>
